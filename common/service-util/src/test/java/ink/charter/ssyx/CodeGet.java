...
public class CodeGet {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\Java_code\\idea_workspace\\MyProject\\SSYX\\charter-ssyx-parent\\service\\service-order"+"/src/main/java");

        gc.setServiceName("%sService");	//去掉Service接口的首字母I
        gc.setAuthor("charter");
        gc.setOpen(false);
